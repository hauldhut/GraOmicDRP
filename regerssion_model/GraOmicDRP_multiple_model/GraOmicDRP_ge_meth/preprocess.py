...
def save_mix_drug_cell_matrix():
    ...
    train_data = TestbedDataset(root='data', dataset=dataset+'_train_mix', xd=xd_train, xt_mut=xc_mut_train, xt_meth=xc_ge_train, y=y_train, smile_graph=smile_graph)
    val_data = TestbedDataset(root='data', dataset=dataset+'_val_mix', xd=xd_val, xt_mut=xc_mut_val, xt_meth=xc_ge_val, y=y_val, smile_graph=smile_graph)
    test_data = TestbedDataset(root='data', dataset=dataset+'_test_mix', xd=xd_test, xt_mut=xc_mut_test, xt_meth=xc_ge_test, y=y_test, smile_graph=smile_graph)
